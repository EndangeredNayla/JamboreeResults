...
def generate_data():
    ...
    try:
        p1_coin_3 = Image.open(f'number/{int(coin_amounts[0][2])}.png')
    ...
    try:
        p2_coin_3 = Image.open(f'number/{int(coin_amounts[1][2])}.png')
    ...
    try:
        p3_coin_3 = Image.open(f'number/{int(coin_amounts[2][2])}.png')
    ...
    try:
        p4_coin_3 = Image.open(f'number/{int(coin_amounts[3][2])}.png')
